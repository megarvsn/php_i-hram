...
$pageCode = 'page-photogallery'; // Символьный код страницы (элемента инфоблока)
...
<? $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "USE_SEARCH" => "N",
        "USE_SHARE" => "N",
        "COMPONENT_TEMPLATE" => "page_photogallery",
        "UP_PAGE_IMAGE" => $pageImage,
        "UP_PAGE_HEAD" => $pageHead,
        "UP_BUTTON_ALL" => $arInterface["btn-all-albums"]["NAME"],
