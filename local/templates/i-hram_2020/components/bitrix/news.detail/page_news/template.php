...
<section class="content ftco-section">
    <div class="container">
        <div class="row">
            <div class="col" id="<? echo $this->GetEditAreaId($arResult['ID']) ?>" itemscope itemtype="http://schema.org/Article">
                <article class="bx-newsdetail-content" itemprop="articleBody">
