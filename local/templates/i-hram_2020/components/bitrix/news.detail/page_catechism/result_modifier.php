...
if ($ar_res = $res->GetNext()) {
    $arResult["MENU"]['HEADER'] = $ar_res["NAME"];
}

$res = CIBlockElement::GetList(
    array("SORT" => "ASC"),
    array("SECTION_ID" => $arResult["IBLOCK_SECTION_ID"], "ACTIVE" => "Y"),
    false,
    false,
    array("NAME", "CODE")
);
...
while ($arFields = $res->GetNext()) {
    $arResult["MENU"]["ELEMENTS"][$cnt]["NAME"] = $arFields["NAME"];
    $arResult["MENU"]["ELEMENTS"][$cnt]["URL"] = $arResult["LIST_PAGE_URL"]. $arFields["CODE"] . "/";
    $cnt++;
}