...
$pageCode = 'page-articles'; // Символьный код страницы (элемента инфоблока)
...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "page_articles",
		...
		"UP_BUTTON_ALL" => $arInterface["btn-all-articles"]["NAME"],
